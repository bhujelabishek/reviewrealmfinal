...
<body>
    ...
    <div style="padding: 20px; background-color: #062900;color: white; text-align: center; align-items: center;
        ...
        <h1>Write Reveiw On Books</h1>
    </div>
    <div class="books">
        <form action="books.php" method="post" class="forms">

            <br><br>
            <div class="newme"><label for="textarea">Books Name:</h1></label><br><br>
        ...
        <div class="review">
            <?php
            include "db.php";
            $sql = mysqli_query($conn, "SELECT `email`, `bookname`, `reviews`, `review_on` FROM `reviews` WHERE `category`='book'");
