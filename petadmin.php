...
<head>
    ...
    <link rel="stylesheet" href="css/petadmin.css">
</head>
<body>
    <nav>
...
//     $feet=mysqli_query($conn,"SELECT `bookname` from `reviews` where `email`='$userprofile' and `category`='pet'");
//     $fet=mysqli_query($conn,"SELECT `reviews` from `reviews` where `email`='$userprofile' and `category`='pet'");
