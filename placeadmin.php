...
<head>
    ...
    <link rel="stylesheet" href="css/placeadmin.css">
</head>
...
<body>
    <nav>
        ...
        border-bottom-left-radius: 200px; border-bottom-right-radius: 200px; border-bottom: white;">
            <h1> Reveiw On Places</h1>
        </div>
<div class="review">
      <?php
            include "db.php";
            $sql = mysqli_query($conn, "SELECT `email`, `bookname`, `reviews` FROM `reviews` WHERE `category`='place'");
